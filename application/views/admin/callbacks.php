                ...
                <div id="abc" hidden class="row">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <textarea class="form-control" name="notesClient" id="c_notesClient" rows="18" id="comment">
                            ...
                            With reference to your site visit on  assisted by Mr. abhishek from Seconds Digital, we thank you for giving us an opportunity to serve you in searching your dream home.  At Citym it is our endeavour to help you with all the possible Property options which will suit your requirement. Mr.  from Citym will be at your service. He/she will be there to assist you in searching your dream home.
...
<!--/tabs-->
									 ...
									 <!--footer section start-->
										<footer>
										   <p>&copy <?= date('Y')?> Citymash . All Rights Reserved | Design by <a href="https://secondsdigital.com/" target="_blank">Seconds Digital.</a></p>
										</footer>
									<!--footer section end-->
								</div>
							</div>
